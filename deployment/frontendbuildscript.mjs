...
//     await $`awk '{gsub(/NEXT_PUBLIC_REST_API_ENDPOINT=.+"$/,"NEXT_PUBLIC_REST_API_ENDPOINT=\\"http://${domainName}/api\\""); print $0}' ./shop/.env.template > ./shop/.env`;
//     // await $`awk '{gsub(/NEXT_PUBLIC_SITE_URL=.+"$/,"NEXT_PUBLIC_SITE_URL=\\"http://${domainName}/shop\\""); print $0}' ./shop/.env.template > ./shop/.env`;
...
//     await $`awk '{gsub(/NEXT_PUBLIC_REST_API_ENDPOINT=.+"$/,"NEXT_PUBLIC_REST_API_ENDPOINT=\\"http://${domainName}/api\\""); print $0}' ./admin/rest/.env.template > ./admin/rest/.env`;
...
//     await $`cp ./shop/.env.template ./shop/.env`;
//     await $`chmod 777 ./shop/.env`;
//     await $`awk '{gsub(/NEXT_PUBLIC_GRAPHQL_API_ENDPOINT=.+"$/,"NEXT_PUBLIC_GRAPHQL_API_ENDPOINT=\\"http://${domainName}/graphql\\""); print $0}' ./shop/.env.template > ./shop/.env`;
...
//     await $`awk '{gsub(/NEXT_PUBLIC_GRAPHQL_API_ENDPOINT=.+"$/,"NEXT_PUBLIC_GRAPHQL_API_ENDPOINT=\\"http://${domainName}/graphql\\""); print $0}' ./admin/graphql/.env.template > ./admin/graphql/.env`;
//     await $`awk '{gsub(/NEXT_PUBLIC_API_ROOT=.+"$/,"NEXT_PUBLIC_API_ROOT=\\"http://${domainName}/api\\""); print $0}' ./admin/graphql/.env > ./admin/graphql/tmp && mv ./admin/graphql/tmp ./admin/graphql/.env && rm -rf ./admin/graphql/tmp`;
